...
void Mainmenu::Update(double dt)
{
	...
	{
		if (Application::IsKeyPressed(0x53) && MainMenu)
		{
			MainMenu = false;
			GameMenu = true;
		}
		if (GameMenu)
		{
			if (Application::IsKeyPressed(0x52) || Application::IsKeyPressed(0x54))
			{
				GameMenu = false;
				CarMenu = true;
			}
		...
		if (CarMenu)
		{
			if (Application::IsKeyPressed(0x42))
			{
				CarMenu = false;
				GameMenu = true;
			}
...
void Mainmenu::Render()
{
	...
	//Mainmenu::RenderSkybox(modelStack, projectionStack, viewStack, MVP);
	//Mainmenu::RenderStadium(modelStack, projectionStack, viewStack, MVP);
	...
	/*for (int Index = 0; Index < Generator.getNumofPiece(); Index++)
	{
		...
		switch (Generator.getMapInfo()[Index][0])
		{
		case 'B':
			switch (Generator.getMapInfo()[Index][1])
			{
			case '0':
			{
...
//void Mainmenu::RenderStadium(MS &modelStack, MS &projectionStack, MS &viewStack, Mtx44 &MVP)
//{
...
//void Mainmenu::RenderSkybox(MS &modelStack, MS &projectionStack, MS &viewStack, Mtx44 &MVP)
//{
